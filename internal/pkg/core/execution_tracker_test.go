...
var _ = Describe("The execution tracker", func() {
	...
	Describe("when retrieving the versioned header template", func() {
		...
		BeforeEach(func() {
			configurationPath := "/path/to/remedy.json"
			...
			trackerFilePath = fakeRepositoryRoot + "/.remedy-run"
		})

		Describe("for the first execution ever of remedy", func() {
		...
		Describe("after an execution of remedy", func() {
  ...
  "data": {"some": "thing"}
				...
				Context("with no errors", func() {
					...
					BeforeEach(func() {
						fileReader.On("Read", trackerFilePath).
							Return([]byte("# Generated by remedy | 1547741491 -- commit me!"), nil)
			...
			Describe("when the former configuration path has been serialized (legacy configuration)", func() {
				Context("with no errors", func() {
					...
					serializedConfigurationPath := "/path/to/former/remedy.json"

					BeforeEach(func() {
						fileReader.On("Read", trackerFilePath).
							Return([]byte("# Generated by remedy | 1547741491 -- commit me!\nconfiguration:"+serializedConfigurationPath), nil)
						vcs.On("LatestRevision", trackerFilePath).
							Return(lastExecutionRevision, nil)
  ...
  "data": {
    "Owner": "Florent Biville (@fbiville)"
				...
				Context("with no errors", func() {
					BeforeEach(func() {
						fileReader.On("Read", trackerFilePath).
							Return([]byte(fmt.Sprintf("# Generated by remedy | 1547741491 -- commit me!\nencoded_configuration:%s\nencoded_header:%s",
	...
	Describe("when tracking remedy execution", func() {
		...
		BeforeEach(func() {
			...
			trackerFilePath = repositoryFakeRoot + "/.remedy-run"
			configurationPath = "/path/to/remedy.json"
			fileMode = 0640
...
limitations under the License.
`
			expectedContents = fmt.Sprintf(`# Generated by remedy | 42 -- commit me!
encoded_configuration:%s
encoded_header:%s
