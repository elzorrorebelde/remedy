...
// Keeps track of remedy execution
type ExecutionTracker interface {
	...
	//
	// If this is the first execution of remedy, the previous execution's template
...
func (evt *ExecutionVcsTracker) TrackExecution(configurationPath *string) error {
	...
	contents := fmt.Sprintf(`# Generated by remedy | %d -- commit me!
